...
struct HttpResponse
{
    httpstatus::HttpStatus status{httpstatus::HttpStatus::OK};
...
// Common helpers
HttpResponse makeText(httpstatus::HttpStatus st, const std::string &text, const std::string &mime = "text/plain; charset=utf-8");
